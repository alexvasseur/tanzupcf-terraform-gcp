resource "google_dns_record_set" "wildcard-sys" {
  name = "*.sys.${var.environment_name}.${var.dns_name}"
  type = "A"
  ttl  = 300
...
resource "google_dns_record_set" "wildcard-apps" {
  name = "*.apps.${var.environment_name}.${var.dns_name}"
  type = "A"
  ttl  = 300
...
resource "google_dns_record_set" "wildcard-websocket" {
  name = "*.ws.${var.environment_name}.${var.dns_name}"
  type = "A"
  ttl  = 300
...
resource "google_dns_record_set" "doppler-sys" {
  name = "doppler.sys.${var.environment_name}.${var.dns_name}"
  type = "A"
  ttl  = 300
...
resource "google_dns_record_set" "loggregator-sys" {
  name = "loggregator.sys.${var.environment_name}.${var.dns_name}"
  type = "A"
  ttl  = 300
...
resource "google_dns_record_set" "ssh" {
  name = "ssh.sys.${var.environment_name}.${var.dns_name}"
  type = "A"
  ttl  = 300
...
resource "google_dns_record_set" "tcp" {
  name = "tcp.${var.environment_name}.${var.dns_name}"
  type = "A"
  ttl  = 300
